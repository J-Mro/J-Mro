...
**Scientific Python** &nbsp;✦&nbsp; *(from my astrophysics days)*
...
Built as part of a **team of 4** at Northcoders, using Agile practices and paired programming throughout.

- **API:** `JavaScript` · `PostgreSQL` · `Express.js` · `Supabase` · `Render` · `Jest` · `SuperTest`
- **Front-End:** `TypeScript` · `React Native Expo` · `TypeScript JSX`

&nbsp;&nbsp;✦ &nbsp;[`borough-books/front-end`](https://github.com/noemi-peterka/BoroughBooks-FE)&nbsp;&nbsp;·&nbsp;&nbsp;[`borough-books/back-end`](https://github.com/NGalletly/BoroughBooks-BE)
